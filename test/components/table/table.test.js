...
describe('Table', () => {
  ...
  describe('column headers', () => {
    it('can be specified', async () => {
      ...
      deepEqual(headings, ['Month you apply', 'Rate for bicycles', 'Rate for vehicles'])
    })
    ...
    it('have HTML escaped when passed as text', async () => {
      ...
      equal($th.html(), 'Foo &lt;script&gt;hacking.do(1337)&lt;/script&gt;')
    })
  ...
  describe('row headers', () => {
    describe('when firstCellIsHeader is false', () => {
      it('are not included', async () => {
        ...
        deepEqual(cells, ['January', '£85', '£95', 'February', '£75', '£55', 'March', '£165', '£125'])
      })
    })
    ...
    describe('when firstCellIsHeader is true', () => {
      ...
      it('have HTML escaped when passed as text', async () => {
        const $ = await render('table', examples['firstCellIsHeader with html as text'])
      ...
      it('can have rowspan specified', async () => {
        const $ = await render('table', examples['firstCellIsHeader with rowspan and colspan'])
  ...
  describe('cells', () => {
    ...
    it('can be skipped when falsely', async () => {
      const $ = await render('table', examples['with falsey items'])
    ...
    it('have HTML escaped when passed as text', async () => {
      ...
      equal($td.html(), 'Foo &lt;script&gt;hacking.do(1337)&lt;/script&gt;')
    })
